...
| [0002](0002-publish-netbraid-crates.md) | Publish the real Netbraid CLI and libraries to crates.io while retaining GitHub binary releases | Superseded by [0005](0005-publish-one-netbraid-package.md) |
...
| [0005](0005-publish-one-netbraid-package.md) | Publish one Netbraid library-and-CLI package while retaining semantic module boundaries | Accepted |
